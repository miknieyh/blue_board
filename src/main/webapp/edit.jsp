	...
	<form action="edit_ok.jsp" method="post">
		<div class="list">
			...
			<table class="table table-bordered border-primary">
				<tr>
					<td class="d-flex"><input type="hidden" name="idx"
						value="${b.idx}">
						...
						<div class="ms-2 col-9">
							<textarea class="noresize h-25 form-control textdiv"
								id="floatingTextarea" name="title" rows="1">${b.title}</textarea>
						</div></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="form-floating">
							<textarea class="noresize h-25 form-control textdiv"
								id="floatingTextarea" name="content" rows="10">${b.content}</textarea>
